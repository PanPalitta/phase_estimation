...
class Candidate {
    ...
    private:
        ...
        int num; /* number of variable*/
        int num_fit; /* number of fitness values (i.e., total number of contraints and objetive functions)*/
        double *cont_fit; /* pointer to array for storing fitness values calculated from the data in contender array*/
        double *best_fit; /* pointer to array for storing fitness values calculated from the data in can_best array*/
        double *global_fit; /* pointer to array for storing fitness values calculated from the data in global_best rray*/
        ...
        bool is_candidate_initialized;

        //memory arrays
        double *contender;  /* the pointer to array that serves mostly as temporary memory that does not survive an interation.*/
        double *can_best; /* the pointer to array that contains solution that would survive several iteration.*/
